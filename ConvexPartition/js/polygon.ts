...
export class Vertex extends Point {
    ...
    constructor(x: number, y: number, incident_edge: HalfEdge = null){
        super(x, y);
    ...
    *edge_iter(){
        var current_edge: HalfEdge = this.incident_edge;
...
export class HalfEdge {
    ...
    constructor(origin: Vertex, twin: HalfEdge = null, next: HalfEdge = null, prev: HalfEdge = null){
        this.origin = origin;
        this.twin = twin;
        this.next = next;
        this.prev = prev;
    ...
    *next_iter(){
        var current_edge: HalfEdge = this;
 ...
 */
function create_edges(vertices: Vertex[]): HalfEdge[]{
    const n = vertices.length;
    var last_pair: [HalfEdge, HalfEdge] = null;
    var first_pair: [HalfEdge, HalfEdge] = null;
...
export class Polygon{
    ...
    */
    insert_diagonal(v: Vertex, u: Vertex): [HalfEdge, HalfEdge]{
    ...
    cw_edge_slope(p: Vertex, q: Vertex): HalfEdge{
